...
class Env(object):
    def __init__(self, width, height, dim):
        ...
        self.__reward_text, self.__reward_text_rect = Text.createText("Reward:", 40, 140)
        self.__eps_text, self.__eps_text_rect = Text.createText("eps:", 40, 160)
        self.__done_text, self.__done_text_rect = Text.createText("Done:", 40, 180)
        self.__loss_text, self.__loss_text_rect = Text.createText("Loss:", 40, 200)
    ...
    def updateEnv(self, nepochs, reward, eps, loss, dones):
        ...
        text_reward, text_reward_rect = Text.createText(str(reward), 90, 140)
        text_eps, text_eps_rect = Text.createText(str(np.round(eps, 2)), 90, 160)
        text_done, text_done_rect = Text.createText(str(dones), 90, 180)
        text_loss, text_loss_rect = Text.createText(str(loss), 90, 200)
        ...
        self.__screen.blit(text_reward, text_reward_rect)
        ...
        self.__screen.blit(self.__reward_text, self.__reward_text_rect)
