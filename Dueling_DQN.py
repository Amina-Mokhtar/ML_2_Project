...
from keras.layers import Dense, Input, Conv2D, Flatten, Lambda, Add, Subtract
...
class Dueling_DQN(object):
    ...
    def __model(self):
        ...
        model = Conv2D(16, (1, 3), activation='relu')(input)
        model = Conv2D(16, (3, 1), activation='relu')(model)
        model = Flatten()(model)
